...
- [ ] `docker build` aprobado desde la misma revisión que se publicará.
- [ ] En Android: panel a ancho completo, menú alineado al volver y tarjetas de invitados legibles.
- [ ] En computadora: “Probar apertura” muestra el sobre y su transición.
- [ ] Tipografía y mayúsculas verificadas en invitación digital, QR e invitación física.
