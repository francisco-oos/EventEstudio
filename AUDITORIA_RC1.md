...
| Dependencias Excel | `xlsx` mantenía avisos de seguridad sin corrección publicada en el paquete instalado | Importación, plantilla y reporte migrados a ExcelJS; auditoría npm sin vulnerabilidades conocidas | Corregido |
...
4. La restauración es deliberadamente offline: sustituir la base en un proceso activo podría mezclar escrituras. La guía documenta parada, verificación y reversión.
